...
cuadrado = num2 ** 2
print(f"El cuadrado de {num2} es: {cuadrado}\n")
...
if num2 != 0:
    ...
    print(f"No se puede realizar el módulo por cero.\n")
...
if num2 != 0:
    ...
    print(f"No se puede realizar la división entera por cero.\n")
...
print(f"La comparación {num1} == {num2} es: {comparacion} \n")
